...
def draw_counts(frame, class_counters, label):
    ...
    """
		...
		# NOTE: This dict is used ONLY for on-screen display colours.
		# It has no effect on detection, counting, TTS, or planogram validation.
		# Those all use the label string directly from labels.json via the Hailo tracker.
		# If a label is missing here it falls back to class_id 0 (same colour only).
		# Update this dict to match your labels.json if you want correct per-class colours.
    class_names = {
        0:  "",
        1:  "chickenKatsuCurry",
        2:  "dakgangjeongRice",
